...
<html lang="fr" class="scroll-smooth">
    <head>
        ...
        <style>
            ...
            .dark main h1,
            .dark main h2,
            .dark main h3 { color: #e6edf7; }
            .dark main p { color: #c4cfdd; }
            ...
            @media (min-width: 768px) {
                .testimonial-marquee { animation: testimonial-scroll 60s linear infinite; }
                .testimonial-rail:hover .testimonial-marquee { animation-play-state: paused; }
            }
            ...
            .problem-card:hover { border-color: #f59e0b; transform: translateY(-2px); }
        </style>
    </head>
    ...
    <body class="bg-[#f8fafc] font-sans text-slate-950 antialiased dark:bg-[#101827] dark:text-[#e6edf7]">
        ...
        <div class="min-h-screen overflow-hidden">
            ...
            <main id="top">
                ...
                ═══════════════════════════════════════════════════ --}}
                <section id="offres" class="mx-auto grid max-w-7xl   gap-8 px-5 py-16 dark:border-white/10 dark:bg-[#101827]">
                    <div>
                  ...
                  @foreach ([
                        ['title' => 'Documents RH centralisés', 'text' => '
                        Contrats, bulletins, attestations et pièces employés archivés proprement. Retrouvés en 10 secondes.'],
    ...
    @foreach ([
        ...
        <article class="rounded-lg border border-white/10 bg-white/5 p-5">
            ...
            <p class="mt-2 leading-7 text-slate-300">{{ $item['text'] }}</p>
        </article>
    @endforeach
</div>
                    </div>
                    ...
                    <div class="mx-auto max-w-7xl px-5 lg:px-8">
                        <div class="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
                            ...
                            <p class="max-w-xs text-sm leading-6 text-slate-500 dark:text-slate-400">
                                Survolez un témoignage pour le lire en détail et mettre le défilement en pause.
                            </p>
                        </div>
                    </div>
    ...
    @endforeach
            ...
            <footer class="bg-slate-950 text-white">
                    ...
                    <div class="grid gap-6 text-sm text-slate-300 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-3 flex flex-col gap-2">
                                ...
                                <a href="{{ route('legal.cookie') }}" wire:navigate class="hover:text-white transition">Cookies</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border-t border-white/10 px-5 py-5 text-center text-sm text-slate-400">
                    ...
                    <a href="{{ route('legal.cgu') }}" wire:navigate class="hover:text-white transition">CGU</a> ·
                    <a href="{{ route('legal.cgv') }}" wire:navigate class="hover:text-white transition">CGV</a> ·
                    <a href="{{ route('legal.cookie') }}" wire:navigate class="hover:text-white transition">Politique de cookies</a>
                </div>
            </footer>
        </div>
